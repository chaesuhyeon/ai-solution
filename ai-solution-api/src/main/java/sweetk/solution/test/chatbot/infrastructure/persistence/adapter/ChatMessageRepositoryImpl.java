...
public class ChatMessageRepositoryImpl implements ChatMessageRepository {
    ...
    @Override
    public ChatMessage findFirstByChatRoomIdAndSenderTypeOrderByCreatedAtDesc(Long chatRoomId, SenderType senderType) {
        ChatMessageEntity message = chatMessageJpaRepository.findFirstByChatRoomIdAndSenderTypeOrderByCreatedAtDesc(chatRoomId, senderType).orElseThrow();
